# SESSION BRIEF – Apache Spark

## 1. Vai trò trong mạch RetailStream

Dùng lại dữ liệu RetailStream để giải thích driver/executor, partition, DAG, job/stage/task, shuffle.
...
- 1 master + >=2 worker.
- Spark UI.
- job có stage/task/partition có thể quan sát.
